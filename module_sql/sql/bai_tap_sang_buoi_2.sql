...
CREATE INDEX IF NOT EXISTS IDX_ORDERS_CUSTOMER_ID ON ORDERS USING HASH (CUSTOMER_ID);
...
CREATE INDEX IF NOT EXISTS IDX_ORDERS_CUSTOMER_ID ON ORDERS (CUSTOMER_ID) INCLUDE (ORDER_NUMBER, TOTAL_AMOUNT, ORDER_DATE);
